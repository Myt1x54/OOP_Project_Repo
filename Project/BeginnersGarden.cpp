...
bool BeginnersGarden::loseLife()
{
    ...
    else if (lives <= 0 || currency >= 5000)
    {
        ...
        LivesText.setPosition(500, 420); // position for new text
        ...
        continueText.setPosition(380, 600); // position
        ...
        while (!spacePressed)
        {
            ...
            while (window.pollEvent(event))
            {
                ...
                {
                    window.close();
                    return true; // game over if window closed
                }
        ...
        return true; // game over after space pressed
    }
